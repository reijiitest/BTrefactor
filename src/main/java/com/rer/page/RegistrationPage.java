...
import static com.rer.util.RandomNameGenerator.randomNameGenerator;
...
public class RegistrationPage extends BasePage{
    ...
    private final String name = testDataReader(16);
    private final String surname = testDataReader(17);
    private final String phoneNumber = testDataReader(18);
    private final String password = testDataReader(19);

    public void fillCredentialsAndSubmit() {
        perform.clickToHidden(fieldSalutationDropDown)
    ...
    public boolean checkRegTitle() {
        ...
        return (title.contains("Customer Registration | World Transfer"));
    }
}
